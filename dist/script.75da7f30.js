...
let imagesLoaded = 0;
let totalImages = 0;
let photosArray = []; // Unsplash API

const initCount = 5;
const apiKey = "xTVogu9WC9IZvvei4pqFf2UgCGLaHTZrlI8m3k9uBZ8";
...
function displayPhotos(arr) {
  ...
  arr.forEach(photo => {
    const {
      ...
      description
    } = photo; // Create <a> to link to Unsplash

    const item = document.createElement('a'); // item.setAttribute('href', html);
    ...
    const img = document.createElement('img'); // img.setAttribute('src', regular);
